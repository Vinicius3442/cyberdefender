...
export class ExplosiveEnemy extends Enemy {
    ...
    // animDie overridden by instant explosion logic in base or Collision?
    // Actually, explosive enemy usually explodes on contact.
    // If shot, it should probably also explode.
